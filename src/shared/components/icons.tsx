// Inline Lucide-style stroke icons (lucide.dev paths, stroke-only rendering).
...
export function ChartPieIcon(props: { size?: number; className?: string }) {
  return (
    <Icon {...props}>
...
export function ActivityIcon(props: { size?: number; className?: string }) {
  return (
    <Icon {...props}>
...
export function InfoIcon(props: { size?: number; className?: string }) {
  return (
    <Icon {...props}>
...
export function RefreshIcon(props: { size?: number; className?: string }) {
  return (
    <Icon {...props}>
...
export function KebabIcon(props: { size?: number; className?: string }) {
  return (
    <Icon {...props}>
...
export function UpdateIcon(props: { size?: number; className?: string }) {
  return (
    <Icon {...props}>
      <circle cx="12" cy="12" r="10" />
